    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand">
                <img src="{!! asset('control-panel/img/logo.png') !!}" alt="Nifty Logo" class="brand-icon">
                            ...
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left">
                                                <img src="{!! asset('control-panel/img/av4.png') !!}" alt="Profile Picture" class="img-circle img-sm">
                                            </div>
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left">
                                                <img src="{!! asset('control-panel/img/av3.png')!!}" alt="Profile Picture" class="img-circle img-sm">
                                            </div>
                                            <div class="media-body">
                ...
                <li class="dropdown">
                    <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
                                <span class="lang-selected">
                                    <img class="lang-flag" src="{!! asset('control-panel/img/flags/united-kingdom.png') !!}" alt="English">
                                </span>
                    </a>
                </li>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="pull-right">
                                    <img class="img-circle img-user media-object" src="{!! asset('control-panel/img/av1.png') !!}" alt="Profile Picture">
                                </span>
                        <div class="username hidden-xs">{{\Illuminate\Support\Facades\Auth::user()->name}}</div>
                    </a>
